...
if not st.session_state.authenticated:
    ...
    .login-box {
        ...
        background: rgba(18,33,49,0.72); border: 1px solid rgba(255,255,255,0.08);
        border-radius: 20px; text-align: center; backdrop-filter: blur(14px);
    }
    .login-box h1 { color: #ffffff; font-size: 32px; margin-bottom: 4px; }
    .login-box p  { color: #cbd8ea; font-size: 13px; margin-bottom: 24px; }
    </style>
    <div class="login-box">
